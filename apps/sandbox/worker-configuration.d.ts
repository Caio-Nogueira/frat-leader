/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0491f50ae24b86d8b57439738237a75e)
// Runtime types generated with workerd@1.20260305.0 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SandboxContainerSidecar";
	}
	interface Env {
		...
		SANDBOX_IMAGE: "docker.io/library/node:22";
		SANDBOX_SIDECAR: DurableObjectNamespace<import("./src/index").SandboxContainerSidecar>;
		SANDBOX_SPAWN_WORKFLOW: Workflow<Parameters<import("./src/index").SandboxSpawnWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SANDBOX_IMAGE">> {}
}
